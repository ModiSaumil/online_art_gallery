                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!--                                <a href=""><button type="button" class="btn btn-rounded btn-info" name="add">
                                                                        <span class="btn-icon-left text-info"><i class="fa fa-remove color-info"></i>
                                                                        </span>Remove</button></a>&nbsp;&nbsp;&nbsp;
                                                                <a href=""><button type="button" class="btn btn-rounded btn-info" name="add">
                                                                        <span class="btn-icon-left text-info"><i class="fa fa-upload color-info"></i>
...
//                                            aid	cid	name	image	price	details
                                            ...
                                            $sel = "select r.fname,r.lname,a.* from tblregistration r inner join tblart a on r.id=a.aid";
                                            ...
                                            while ($R = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td> " . $R['name'] . "</td>";
                                                echo "<td><img src=../artist/" . $R['image'] . " width=50% height=50% alt='" . $R['image'] . "'></td>";
                                                echo "<td>" . $R['price'] . "</td>";
                                                echo "<td>" . $R['details'] . "</td>";
                                                ?>

            <!--<<img src="" width="width" height="height" alt="alt"/>-->
                                            <td>
                                                <span>
                                                     <?php echo " <a href='admin_editartdetails.php?arteid=".$R['id']."' class='mr-4' data-toggle='tooltip' data-placement='top' title='Edit' name='pencil'><i class='fa fa-pencil color-muted'></i> </a>" ?>
                                                    
<!--                                                    <a href="admin_editartdetails.php" class="mr-4" data-toggle="tooltip"
                                                       data-placement="top" title="Edit" name="pencil"><i
                                                            class="fa fa-pencil color-muted"></i> </a>-->
                                                            <a href="#" data-toggle="tooltip"
                                                                   data-placement="top" title="Close" name="close">
...
//                                                $del = "delete from tblart where id='$a'";
//                                                $result = mysqli_query($conn, $del);
//
//                                                if ($result) {
//                                                    // echo "deleted";
//                                                    header('location:./admin_arts.php');
//                                                } else {
//                                                    echo "no deleted";
//                                                }
//                                            }
