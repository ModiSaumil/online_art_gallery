...
<!--                                    <div class="stat-content d-inline-block">
                                        <a href="admin_vieworder.php">
                                            <div class="stat-text">View Orders</div>-->
                                            <?php
                                            
                                            if ($queryart = mysqli_query($con, "select * from tblart"))
                                                ;
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered verticle-middle table-responsive-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                            <?php
                                            $sel = "select * from tblregistration";
                                            $result = mysqli_query($con, $sel);

                                            if (mysqli_num_rows($result) >0 ) {
                                            //echo "datta is";
                                            //echo "<table border='1px'> <tr> <th>Customer id </th> <th>Customer First Name </th> <th>Customer Last Name </th> <th>Gender </th> <th>Mobile Number</th> <th>Address</th> <th>City</th> <th>Pincode</th> <th>Email-Id</th></tr>";
                                            }
                                            else
                                            {
