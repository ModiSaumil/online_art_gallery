                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add new Art</h4>
                            </div>
                            <div class="card-body">
                                            ...
                                            <div class="basic-form">
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" placeholder="Art Name" name="name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea type="text" class="form-control" placeholder="Enter Art Details.." name="details"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    if (isset($_POST['submit'])) {
                                                        ...
                                                        $ext = explode(".", $des)[1];
                                                        if ($ext == 'jpg' || 'png' || 'jpeg') {
                                                            $artistid = mysqli_query($con, "select id from tblregistration where email='" . $_SESSION['indexname'] . "'");
                                                            $arresult = mysqli_fetch_assoc($artistid);
                                                            $ar = $arresult["id"];

                                                            $insert = "INSERT INTO tblart(aid,cid,name,image,price,details) VALUES ('" . $ar . "','" . $_POST['cat'] . "','" . $_POST['name'] . "','" . $des . "','" . $_POST['price'] . "','" . $_POST['details'] . "')";
                                                            ...
                                                            <?php
//                                                             echo "input image is not a png or jpg or jpeg";
                                                        }
                                                    }
//                                                  
                                                    ?>
